  ...
  const socialLinks = [
    {
      ...
      color: "text-[#E4405F] bg-pink-50 hover:bg-[#E4405F] hover:text-white",
    },
    {
      icon: MessageCircle,
      href: "https://wa.me/917378670369",
      color: "text-[#25D366] bg-green-50 hover:bg-[#25D366] hover:text-white",
    },
    {
      icon: Mail,
      href: "mailto:bhagupatil10@gmail.com",
      color: "text-[#EA4335] bg-red-50 hover:bg-[#EA4335] hover:text-white",
    },
  ];

  return (
    <div className="min-h-screen w-full bg-slate-50 pt-2 pb-24 sm:py-8 px-4 sm:px-6 md:px-8 font-sans overflow-x-hidden selection:bg-blue-200 selection:text-blue-900">
      {/* Background Decor */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        {/* Header Section */}
        <div className="text-center mt-6 mb-8 md:mt-8 md:mb-12">
        ...
        {/* Main Card Container - Adjusted border radius for mobile */}
        <div className="flex flex-col lg:flex-row bg-white rounded-3xl md:rounded-[2.5rem] shadow-xl shadow-slate-200/60 overflow-hidden border border-white/50 backdrop-blur-sm">
          {/* Left Panel: Info (Dark Mode Card) */}
          <div className="relative lg:w-5/12 bg-slate-900 p-6 sm:p-8 md:p-12 overflow-hidden flex flex-col justify-between min-h-fit lg:min-h-[500px]">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                <div className="flex items-center p-4 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300 group">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-xs text-slate-400 mt-0.5 leading-relaxed">
                      shop no 2, Vishwavihar apt, near lijjat papad shop, ganesh
                      chawk manjarli, badlapur west, India
                    </p>
                  </div>
                </div>
          ...
          <div className="lg:w-7/12 p-6 sm:p-8 md:p-12 relative bg-white">
            <div className="max-w-xl mx-auto">
              ...
              {status && (
                <div
                  className={`mb-8 p-4 rounded-2xl flex items-start gap-3 text-sm font-medium animate-fade-in ${
                    status === "success"
                ...
                >
                  ...
                  >
                    ...
                    {status === "Sending..." && (
                      <div className="w-3 h-3 border-2 border-current border-t-transparent rounded-full animate-spin text-blue-700"></div>
                    )}
                  </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                ...
                <div className="pt-2 flex justify-center w-full max-w-full overflow-hidden mx-auto">
                  <div className="recaptcha-wrapper transform origin-center">
                    <ReCAPTCHA
      ...
      >
        <span className="text-xs md:text-sm font-bold text-slate-700 group-hover:text-green-600 transition-colors hidden xs:block ml-2 md:ml-0">
          Chat with us
        </span>
      ...
      <style jsx="true">{`
        ...
        /* Hide text on very small screens for whatsapp button */
