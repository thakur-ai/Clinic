...
const OfflineAppointmentBookingPage = () => {
  ...
  const handleOfflineBookingSubmit = async (e) => {
    ...
    try {
      const bookingResponse = await fetch(
        `${API_BASE_URL}/admin/appointments/offline`,
        {
          method: "POST",
          headers: {
      ...
      if (!bookingResponse.ok)
        throw new Error(bookingData.message || "Offline booking failed.");
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative overflow-x-hidden py-4 sm:py-8 px-3 sm:px-6 lg:px-8 font-sans mt-[30px] md:mt-[50px] selection:bg-indigo-100">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div
          className="absolute top-[-10%] left-[-10%] w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-indigo-300/30 rounded-full blur-[80px] md:blur-[120px] transition-transform duration-100 ease-out animate-pulse-slow"
          style={{
            transform: `translate(${xOffset * -1.5}px, ${yOffset * -1.5}px)`,
          }}
        ></div>

        <div
          className="absolute bottom-[-10%] right-[-10%] w-[250px] md:w-[500px] h-[250px] md:h-[500px] bg-blue-300/30 rounded-full blur-[60px] md:blur-[100px] transition-transform duration-100 ease-out animate-pulse-slow delay-700"
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="bg-white/90 md:bg-white/80 backdrop-blur-md md:backdrop-blur-xl rounded-2xl md:rounded-3xl shadow-[0_10px_30px_rgba(0,0,0,0.1)] md:shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-white/50 animate-fade-in flex flex-col lg:flex-row overflow-hidden">
          <form
            onSubmit={handleOfflineBookingSubmit}
            className="flex-1 p-5 md:p-8 lg:p-12 space-y-6 md:space-y-10 relative"
          >
            <section>
              <div className="flex items-center gap-2 mb-4 md:mb-6">
                <div className="flex items-center justify-center w-7 h-7 rounded-full bg-indigo-600 text-white font-bold text-xs shadow-lg shadow-indigo-200 shrink-0">
                  1
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="group overflow-visible z-30">
                  ...
                  <div className="relative" ref={serviceDropdownRef}>
                    ...
                    />
                    <div
                      className="custom-select w-full pl-10 pr-2 py-3 md:py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl text-gray-700 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none text-sm md:text-base shadow-sm cursor-pointer flex items-center justify-between hover:border-indigo-300"
                      onClick={(e) => {
                        e.stopPropagation();
                        setShowServiceDropdown(!showServiceDropdown);
                      }}
                ...
                <div className="group z-20">
                  ...
                  <div className="relative group-focus-within:scale-[1.02] transition-transform duration-200">
                    ...
                    <select
                      className="custom-select w-full pl-10 pr-8 py-3 md:py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl text-gray-700 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none text-sm md:text-base shadow-sm truncate"
              ...
              <div className="group overflow-visible z-10 mt-4 md:mt-0">
                <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2 ml-1">
                  Date
                </label>
                <div
                ...
                >
                  ...
                  <DatePicker
                    ...
                    className={`w-full pl-10 pr-2 py-3 md:py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl text-gray-700 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none text-sm md:text-base shadow-sm ${
              ...
              <div className="group mt-4 md:mt-0">
                ...
                <div className="relative group-focus-within:scale-[1.02] transition-transform duration-200">
                  ...
                  <select
                    className={`custom-select w-full pl-10 pr-8 py-3 md:py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl text-gray-700 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none text-sm md:text-base shadow-sm ${
            ...
            <div className="lg:hidden flex justify-between items-center py-2 border-t border-gray-100 mt-2">
            ...
            <button
              ...
              className={`
                relative z-10 w-full py-3.5 md:py-4 px-6 rounded-xl text-white font-bold text-sm md:text-lg shadow-xl shadow-indigo-200
                transition-all duration-300 transform active:scale-95 hover:shadow-2xl hover:-translate-y-1 overflow-hidden
                ${
                  isSubmitting
            ...
            >
              ...
              {isSubmitting ? (
                ...
                <span className="flex items-center justify-center gap-2 relative z-10">
                  ...
                  <FaMoneyBillWave className="text-green-200 opacity-80" />
                </span>
              )}
            </button>
          </form>

          {/* Summary Section - Visible on Mobile too now (below form), but styled as sidebar on desktop */}
          <div className="w-full lg:w-1/3 bg-slate-50/50 backdrop-blur-sm border-t lg:border-t-0 lg:border-l border-slate-200 p-5 md:p-8 lg:p-12 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="bg-white/80 p-4 md:p-6 rounded-xl shadow-sm border border-slate-200/60 space-y-3 mb-4 md:mb-8 backdrop-blur-md">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-slate-200 mt-4">
                  ...
                  <span className="text-xl md:text-2xl font-extrabold text-indigo-700">
                    ₹{totalAmount.toLocaleString()}
                  </span>
                </div>
              </div>
